...
| **Codex** | Desktop / embedded / PATH; WSL `~/.codex` is **separate** from Windows Desktop `%USERPROFILE%\.codex` unless synced via `CODEX_HOME` | TOML agents | `~/.codex/agents/` + project `.codex/` |
