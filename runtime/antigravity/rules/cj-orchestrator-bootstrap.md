...
**En criollo (REQUIRED):** every implementer handoff and technical close-out includes `## En criollo` (3–6 plain sentences: what changes in practice for human/team/device — install, update, chats, models, links, friction). See `.cursor/rules/cj-criollo-changelog.mdc` (Cursor) and `AGENTS.md` / skill.
